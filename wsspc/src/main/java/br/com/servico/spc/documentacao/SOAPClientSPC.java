package br.com.servico.spc.documentacao;
...
public class SOAPClientSPC {
	...
	public static void main(String args[]) {
		callSoapWebServiceIncusao(soapEndpointUrl, soapActionIncusao);
		callSoapWebServiceExclusao(soapEndpointUrl, soapActionExclusao);
	}

	private static void createSoapEnvelopeInclusao(SOAPMessage soapMessage) throws SOAPException {
	...
	private static void createSoapEnvelopeExclusao(SOAPMessage soapMessage) throws SOAPException {
		SOAPPart soapPart = soapMessage.getSOAPPart();
	...
	private static void callSoapWebServiceIncusao(String soapEndpointUrl, String soapActionIncusao) {
		try {
			SOAPConnectionFactory soapConnectionFactory = SOAPConnectionFactory.newInstance();
			SOAPConnection soapConnection = soapConnectionFactory.createConnection();
			SOAPMessage soapResponse = soapConnection.call(createSOAPRequestIncusao(soapActionIncusao),
					soapEndpointUrl);
	...
	private static void callSoapWebServiceExclusao(String soapEndpointUrl, String soapActionExclusao) {
		try {
			SOAPConnectionFactory soapConnectionFactory = SOAPConnectionFactory.newInstance();
			SOAPConnection soapConnection = soapConnectionFactory.createConnection();
			SOAPMessage soapResponse = soapConnection.call(createSOAPRequestExclusao(soapActionExclusao),
					soapEndpointUrl);
			System.out.println("Response SOAP Message:");
			soapResponse.writeTo(System.out);
			System.out.println();
	...
	private static SOAPMessage createSOAPRequestIncusao(String soapActionIncusao) throws Exception {
		MessageFactory messageFactory = MessageFactory.newInstance();
		SOAPMessage soapMessage = messageFactory.createMessage();
		createSoapEnvelopeInclusao(soapMessage);
	...
	private static SOAPMessage createSOAPRequestExclusao(String soapActionExclusao) throws Exception {
		MessageFactory messageFactory = MessageFactory.newInstance();
		SOAPMessage soapMessage = messageFactory.createMessage();
		createSoapEnvelopeExclusao(soapMessage);
		MimeHeaders headers = soapMessage.getMimeHeaders();
