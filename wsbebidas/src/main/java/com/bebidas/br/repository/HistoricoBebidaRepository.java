...
public interface HistoricoBebidaRepository extends JpaRepository<HistoricoBebida, Long> {
	...
	@Query("SELECT  h FROM  HistoricoBebida  h where " + "INNER JOIN Estoque e on e.idEsqtoque=h.estoque.idEstoque"
			+ "INNER JOIN Bebida b on b.idBebida=e.bebida.idBebida" + "e.sessao.idSessao=:sessao and"
